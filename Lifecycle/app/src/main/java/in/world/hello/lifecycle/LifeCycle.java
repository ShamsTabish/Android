package in.world.hello.lifecycle;
...
public class LifeCycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("LifeCycle","Successfully created the UI");
    }

    public boolean display(View view){
        TextView uname=(TextView)findViewById(R.id.userneme);
        uname.setText("Hey! We are Done");
