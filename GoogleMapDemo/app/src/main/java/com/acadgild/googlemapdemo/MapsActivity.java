...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        sydneyOptions.position(sydney);
        sydneyOptions.title("Marker in Sydney");
        ...
        mMap.addMarker(new MarkerOptions().position(india).title("India").snippet("Lovely India.").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher)));
